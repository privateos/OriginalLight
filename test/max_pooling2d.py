...
t1 = graph.max_pooling2d(x1, 2, 2, 2, 2)
t2 = graph.add(t1, x2)
t3 = graph.tanh(t2)
t4 = graph.add(t3, x3)
y = graph.mean(t4)
...
#t_t1 = tf.nn.max_pool(t_x1, (1, 2, 2, 1), (1, 1, 1, 1), padding='VALID')
t_t1 = tf.nn.max_pool(t_x1, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='VALID')
...
with tf.Session() as t_sess:
    epochs = 100
    x1_shape = (10, 28, 30, 3)#(10, 14, 15, 3)
    x2_shape = (10, 14, 15, 3)
    x3_shape = (10, 14, 15, 3)
