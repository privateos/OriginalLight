...
t3 = graph.max(t1, axis=1, keepdims=False)
t4 = graph.max(t2, axis=1, keepdims=False)
t9 = graph.add(t3, t4)
y = graph.mean(t9)
...
t_t3 = tf.reduce_max(t_t1, axis=1, keepdims=False)
t_t4 = tf.reduce_max(t_t2, axis=1, keepdims=False)
t_t9 = t_t3 + t_t4
